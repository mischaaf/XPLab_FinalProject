...
/* for loop for first trial:
   ...
   a rating scale for each image; pushes information for each picture onto the first trial array to save them */
for(i=0; i<30; i++) {
  trials_like.push({
...
/* for loop for second trial:
   traverses through all randomised stimuli images and presents the participant with
   a rating scale for each image; pushes information for each picture onto the second trial array to save them */
for(i=0; i<30; i++) {
  trials_objects.push({
